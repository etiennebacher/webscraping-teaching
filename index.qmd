...
<!-- TODO: -->
<!-- - trycatch -->
<!-- - politeness -> possible ? -> Let's say that NO -->
...
If you clean the browser by hand and try to re-run the script, you may have the
following error:
...
**No!**^[Although, in this case, it would be ok to treat it directly in the same
script.]
...
Problem: what if the Internet connection is so bad that the loading takes 7 seconds?
...
```{.r code-line-numbers="1,2,3,17|5-12|13-16"}
...
This loop will run until the buttons can be found.
...
* [article by Appsilon](https://appsilon.com/webscraping-dynamic-websites-with-r/) (at the end)

* [article by Ivan Millanes](https://ivanmillanes.netlify.app/post/2020-06-30-webscraping-with-rselenium-and-rvest/#parallel-framework)
...
[https://github.com/etiennebacher/webscraping-teaching/issues](https://github.com/etiennebacher/webscraping-teaching/issues)
...
[https://appsilon.com/webscraping-dynamic-websites-with-r/](https://appsilon.com/webscraping-dynamic-websites-with-r/)

<br>

Article from Ivan Millanes:

[https://ivanmillanes.netlify.app/post/2020-06-30-webscraping-with-rselenium-and-rvest/](https://ivanmillanes.netlify.app/post/2020-06-30-webscraping-with-rselenium-and-rvest/)
