...
different (see [Premier League stats](https://www.premierleague.com/stats/top/players/goal_assist){.external target="_blank"}).
...
Also available on [Github](){.external target="_blank"}:
